...
public class InternalEditBook extends javax.swing.JInternalFrame {
     ...
     */
    public InternalEditBook(Controlador controlador_cliente) {
    ...
    private void buttonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonEditarActionPerformed
       ...
       //String mensaje = controlador_cliente.editarLibro(isbn, titulo, resumen, autor, portada, precio, categoria, bestSeller, edadMinima, calificacion);
    ...
    private void buttonCargarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonCargarActionPerformed
        /*String[] datos = controlador_cliente.consultarDatosLibro(this.fieldIsbn.getText());
        if(datos.length == 1){
